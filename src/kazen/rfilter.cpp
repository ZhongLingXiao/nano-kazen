...
public:
    ...
    std::string toString() const {
        return fmt::format("GaussianFilter[radius={}, stddev={}]", m_radius, m_stddev);
    }
protected:
    float m_stddev;
};
...
public:
    ...
    std::string toString() const {
        return fmt::format("MitchellNetravaliFilter[radius={}, B={}, C={}]", m_radius, m_B, m_C);
    }
protected:
    float m_B, m_C;
};
...
KAZEN_REGISTER_CLASS(GaussianFilter, "gaussian");
KAZEN_REGISTER_CLASS(MitchellNetravaliFilter, "mitchell");
KAZEN_REGISTER_CLASS(TentFilter, "tent");
KAZEN_REGISTER_CLASS(BoxFilter, "box");
